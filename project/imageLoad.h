...
inline unsigned char* loadTGA(const char* name, int& width, int& height, unsigned short& channels){
...
inline unsigned char* loadBMP(const char* filename, int& width, int& height, unsigned short& channels) {
	std::ifstream file;
...
inline bool setTexture(const char* name, unsigned int * texture, bool mipmap){
